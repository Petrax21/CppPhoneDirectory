...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/home/mustafa/Codes/PhoneDirectoryBackcpp/cmake-build-debug/vcpkg_installed/x64-linux' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/mustafa/Codes/PhoneDirectoryBackcpp/cmake-build-debug/vcpkg_installed/x64-linux/lib' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/mustafa/.vcpkg-clion/vcpkg/packages/libpq_x64-linux/lib/pkgconfig:/home/mustafa/.vcpkg-clion/vcpkg/packages/libpq_x64-linux/share/pkgconfig:/home/mustafa/Codes/PhoneDirectoryBackcpp/cmake-build-debug/vcpkg_installed/x64-linux/lib/pkgconfig:/home/mustafa/Codes/PhoneDirectoryBackcpp/cmake-build-debug/vcpkg_installed/x64-linux/share/pkgconfig:/usr/local/lib/x86_64-linux-gnu/pkgconfig:/usr/local/lib/pkgconfig:/usr/local/share/pkgconfig:/usr/lib/x86_64-linux-gnu/pkgconfig:/usr/lib/pkgconfig:/usr/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.4 on x86_64-pc-linux-gnu, compiled by cc (Ubuntu 13.2.0-23ubuntu4) 13.2.0, 64-bit"
